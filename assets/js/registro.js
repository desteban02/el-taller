...
const methods = {
  ...
  setInfoPerson() {
    ...
    document.getElementById("nombre").value = "Daniel";
    document.getElementById("apellido").value = "Bedoya";
    document.getElementById("correo").value = "daniel.esteban.lds@gmail.com";
    document.getElementById("celular").value = "3003483914";
  ...
  getInfoPerson() {
    ...
    let terminos_condiciones = document.getElementById("terminos_condiciones")
      .checked;
